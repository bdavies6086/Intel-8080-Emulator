...
for(var i = 0; i < invadersDump.length;) {
    var opCode = invadersDump.slice(i, 2+i);
    opCode = "0x" + opCode;
    var output = byteCounter.toString(16);
    i = i+2;
    ...
    switch(opCode) {
        ...
        case "0x01": {
            output = output +` LXI B ${invadersDump.slice(i,2+i)} D16 ${invadersDump.slice(i+2,4+i)}`;
            i=i+4;
            additionalBytes = 2;
            break;
        }
        case "0x02": {
            output = output +" STAX B";
            break;
        }
        case "0x03": {
            output = output +" INX B";
        ...
        case "0x06": {
            output = output +` MVI B D8${invadersDump.slice(i,2+i)}`
            i=i+2;
            additionalBytes = 1;
            break;
        }
        ...
        case "0x0e": { 
             output = output + `MVI C,D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;
            }
        
        case "0x0f": {output = output +"  RRC"; break;}
        case "0x10": {output = output +"  -"; break;}
        case "0x11": {output = output +`  LXI D ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0x12": {output = output +" STAX D"; break;}
        case "0x13": {output = output +" INX D"; break;}
        case "0x14": {output = output +" INR D"; break;}
        case "0x15": {output = output +" DCR D"; break;}
        case "0x16": {output = output +` MV D, D8 D${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0x17": {output = output +" RAL"; break;}
        case "0x18": {output = output +" -"; break;}
        case "0x19": {output = output +" DAD D"; break;}
        case "0x1a": {output = output +" LDAX D"; break;}
        case "0x1b": {output = output +" DCX D"; break;}
        case "0x1c": {output = output +" INR E"; break;}
        case "0x1d": {output = output +" DCR E"; break;}
        case "0x1e": {output = output +` MVI E, D8 E= ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0x1f": {output = output +" RAR"; break;}
        case "0x20": {output = output +" -"; break;}
        case "0x21": {output = output +` LXI ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0x22": {output = output +` SHLD ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0x23": {output = output +" INX H"; break;}
        case "0x24": {output = output +" INR H"; break;}
        case "0x25": {output = output +" DCR H"; break;}
        case "0x26": {output = output +` MVI H ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0x27": {output = output +" DAA"; break;}
        case "0x28": {output = output +" -"; break;}
        case "0x29": {output = output +" DAD H"; break;}
        case "0x2a": {output = output +` LHLD ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0x2b": {output = output +" DCX H"; break;}
        case "0x2c": {output = output +" INR L"; break;}
        case "0x2d": {output = output +" DCR L"; break;}
        case "0x2e": {output = output +` MV L ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0x2f": {output = output +" CMA"; break;}
        case "0x30": {output = output +" -"; break;}
        case "0x31": {output = output +` LXI SP ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2;  break;}
        case "0x32": {output = output +` STA ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0x33": {output = output +" INX SP"; break;}
        case "0x34": {output = output +" INR M"; break;}
        case "0x35": {output = output +" DCR M"; break;}
        case "0x36": {output = output +` MVI M ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0x37": {output = output +" STC"; break;}
        case "0x38": {output = output +" -"; break;}
        case "0x39": {output = output +" DAD SP"; break;}
        case "0x3a": {output = output +` LDA ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0x3b": {output = output +" DCX SP"; break;}
        case "0x3c": {output = output +" INR A"; break;}
        case "0x3d": {output = output +" DCR A"; break;}
        case "0x3e": {output = output +` MVI A ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0x3f": {output = output +" CMC"; break;}
        case "0x40": {output = output +" MOV B,B"; break;}
        case "0x41": {output = output +" MOV B,C"; break;}
        case "0x42": {output = output +" MOV B,D"; break;}
        case "0x43": {output = output +" MOV B,E"; break;}
        case "0x44": {output = output +" MOV B,H"; break;}
        case "0x45": {output = output +" MOV B,L"; break;}
        case "0x46": {output = output +" MOV B,M"; break;}
        case "0x47": {output = output +" MOV B,A"; break;}
        case "0x48": {output = output +" MOV C,B"; break;}
        case "0x49": {output = output +" MOV C,C"; break;}
        case "0x4a": {output = output +" MOV C,D"; break;}
        case "0x4b": {output = output +" MOV C,E"; break;}
        case "0x4c": {output = output +" MOV C,H"; break;}
        case "0x4d": {output = output +" MOV C,L"; break;}
        case "0x4e": {output = output +" MOV C,M"; break;}
        case "0x4f": {output = output +" MOV C,A"; break;}
        case "0x50": {output = output +" MOV D,B"; break;}
        case "0x51": {output = output +" MOV D,C"; break;}
        case "0x52": {output = output +" MOV D,D"; break;}
        case "0x53": {output = output +" MOV D,E"; break;}
        case "0x54": {output = output +" MOV D,H"; break;}
        case "0x55": {output = output +" MOV D,L"; break;}
        case "0x56": {output = output +" MOV D,M"; break;}
        case "0x57": {output = output +" MOV D,A"; break;}
        case "0x58": {output = output +" MOV E,B"; break;}
        case "0x59": {output = output +" MOV E,C"; break;}
        case "0x5a": {output = output +" MOV E,D"; break;}
        case "0x5b": {output = output +" MOV E,E"; break;}
        case "0x5c": {output = output +" MOV E,H"; break;}
        case "0x5d": {output = output +" MOV E,L"; break;}
        case "0x5e": {output = output +" MOV E,M"; break;}
        case "0x5f": {output = output +" MOV E,A"; break;}
        case "0x60": {output = output +" MOV H,B"; break;}
        case "0x61": {output = output +" MOV H,C"; break;}
        case "0x62": {output = output +" MOV H,D"; break;}
        case "0x63": {output = output +" MOV H,E"; break;}
        case "0x64": {output = output +" MOV H,H"; break;}
        case "0x65": {output = output +" MOV H,L"; break;}
        case "0x66": {output = output +" MOV H,M"; break;}
        case "0x67": {output = output +" MOV H,A"; break;}
        case "0x68": {output = output +" MOV L,B"; break;}
        case "0x69": {output = output +" MOV L,C"; break;}
        case "0x6a": {output = output +" MOV L,D"; break;}
        case "0x6b": {output = output +" MOV L,E"; break;}
        case "0x6c": {output = output +" MOV L,H"; break;}
        case "0x6d": {output = output +" MOV L,L"; break;}
        case "0x6e": {output = output +" MOV L,M"; break;}
        case "0x6f": {output = output +" MOV L,A"; break;}
        case "0x70": {output = output +" MOV M,B"; break;}
        case "0x71": {output = output +" MOV M,C"; break;}
        case "0x72": {output = output +" MOV M,D"; break;}
        case "0x73": {output = output +" MOV M,E"; break;}
        case "0x74": {output = output +" MOV M,H"; break;}
        case "0x75": {output = output +" MOV M,L"; break;}
        case "0x76": {output = output +" HLT"; break;}
        case "0x77": {output = output +" MOV M,A"; break;}
        case "0x78": {output = output +" MOV A,B"; break;}
        case "0x79": {output = output +" MOV A,C"; break;}
        case "0x7a": {output = output +" MOV A,D"; break;}
        case "0x7b": {output = output +" MOV A,E"; break;}
        case "0x7c": {output = output +" MOV A,H"; break;}
        case "0x7d": {output = output +" MOV A,L"; break;}
        case "0x7e": {output = output +" MOV A,M"; break;}
        case "0x7f": {output = output +" MOV A,A"; break;}
        case "0x80": {output = output +" ADD B"; break;}
        case "0x81": {output = output +" ADD C"; break;}
        case "0x82": {output = output +" ADD D"; break;}
        case "0x83": {output = output +" ADD E"; break;}
        case "0x84": {output = output +" ADD H"; break;}
        case "0x85": {output = output +" ADD L"; break;}
        case "0x86": {output = output +" ADD M"; break;}
        case "0x87": {output = output +" ADD A"; break;}
        case "0x88": {output = output +" ADC B"; break;}
        case "0x89": {output = output +" ADC C"; break;}
        case "0x8a": {output = output +" ADC D"; break;}
        case "0x8b": {output = output +" ADC E"; break;}
        case "0x8c": {output = output +" ADC H"; break;}
        case "0x8d": {output = output +" ADC L"; break;}
        case "0x8e": {output = output +" ADC M"; break;}
        case "0x8f": {output = output +" ADC A"; break;}
        case "0x90": {output = output +" SUB B"; break;}
        case "0x91": {output = output +" SUB C"; break;}
        case "0x92": {output = output +" SUB D"; break;}
        case "0x93": {output = output +" SUB E"; break;}
        case "0x94": {output = output +" SUB H"; break;}
        case "0x95": {output = output +" SUB L"; break;}
        case "0x96": {output = output +" SUB M"; break;}
        case "0x97": {output = output +" SUB A"; break;}
        case "0x98": {output = output +" SBB B"; break;}
        case "0x99": {output = output +" SBB C"; break;}
        case "0x9a": {output = output +" SBB D"; break;}
        case "0x9b": {output = output +" SBB E"; break;}
        case "0x9c": {output = output +" SBB H"; break;}
        case "0x9d": {output = output +" SBB L"; break;}
        case "0x9e": {output = output +" SBB M"; break;}
        case "0x9f": {output = output +" SBB A"; break;}
        case "0xa0": {output = output +" ANA B"; break;}
        case "0xa1": {output = output +" ANA C"; break;}
        case "0xa2": {output = output +" ANA D"; break;}
        case "0xa3": {output = output +" ANA E"; break;}
        case "0xa4": {output = output +" ANA H"; break;}
        case "0xa5": {output = output +" ANA L"; break;}
        case "0xa6": {output = output +" ANA M"; break;}
        case "0xa7": {output = output +" ANA A"; break;}
        case "0xa8": {output = output +" XRA B"; break;}
        case "0xa9": {output = output +" XRA C"; break;}
        case "0xaa": {output = output +" XRA D"; break;}
        case "0xab": {output = output +" XRA E"; break;}
        case "0xac": {output = output +" XRA H"; break;}
        case "0xad": {output = output +" XRA L"; break;}
        case "0xae": {output = output +" XRA M"; break;}
        case "0xaf": {output = output +" XRA A"; break;}
        case "0xb0": {output = output +" ORA B"; break;}
        case "0xb1": {output = output +" ORA C"; break;}
        case "0xb2": {output = output +" ORA D"; break;}
        case "0xb3": {output = output +" ORA E"; break;}
        case "0xb4": {output = output +" ORA H"; break;}
        case "0xb5": {output = output +" ORA L"; break;}
        case "0xb6": {output = output +" ORA M"; break;}
        case "0xb7": {output = output +" ORA A"; break;}
        case "0xb8": {output = output +" CMP B"; break;}
        case "0xb9": {output = output +" CMP C"; break;}
        case "0xba": {output = output +" CMP D"; break;}
        case "0xbb": {output = output +" CMP E"; break;}
        case "0xbc": {output = output +" CMP H"; break;}
        case "0xbd": {output = output +" CMP L"; break;}
        case "0xbe": {output = output +" CMP M"; break;}
        case "0xbf": {output = output +" CMP A"; break;}
        case "0xc0": {output = output +" RNZ"; break;}
        case "0xc1": {output = output +" POP B"; break;}
        case "0xc2": {output = output +` JNZ adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xc3": {output = output +` JMP adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xc4": {output = output +` CNZ adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xc5": {output = output +" PUSH B"; break;}
        case "0xc6": {output = output +` ADI D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xc7": {output = output +" RST 0"; break;}
        case "0xc8": {output = output +" RZ"; break;}
        case "0xc9": {output = output +" RET"; break;}
        case "0xca": {output = output +` JZ adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xcb": {output = output +" -"; break;}
        case "0xcc": {output = output +` CZ adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xcd": {output = output +` CALL adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xce": {output = output +` ACI D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xcf": {output = output +" RST 1"; break;}
        case "0xd0": {output = output +" RNC"; break;}
        case "0xd1": {output = output +" POP D"; break;}
        case "0xd2": {output = output +` JNC adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xd3": {output = output +` OUT D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xd4": {output = output +` CNC adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xd5": {output = output +" PUSH D"; break;}
        case "0xd6": {output = output +` SUI D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xd7": {output = output +" RST 2"; break;}
        case "0xd8": {output = output +" RC"; break;}
        case "0xd9": {output = output +" -"; break;}
        case "0xda": {output = output +` JC adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xdb": {output = output +` IN D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xdc": {output = output +` CC adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xdd": {output = output +" -"; break;}
        case "0xde": {output = output +` SBI D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xdf": {output = output +" RST 3"; break;}
        case "0xe0": {output = output +" RPO"; break;}
        case "0xe1": {output = output +" POP H"; break;}
        case "0xe2": {output = output +` JPO adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xe3": {output = output +" XTHL"; break;}
        case "0xe4": {output = output +` CPO adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; i=i+4; additionalBytes = 2; break;}
        case "0xe5": {output = output +" PUSH H"; break;}
        case "0xe6": {output = output +` ANI D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xe7": {output = output +" RST 4"; break;}
        case "0xe8": {output = output +" RPE"; break;}
        case "0xe9": {output = output +" PCHL"; break;}
        case "0xea": {output = output +` JPE adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; additionalBytes = 2; i=i+4; break;}
        case "0xeb": {output = output +" XCHG"; break;}
        case "0xec": {output = output +` CPE adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; additionalBytes = 2; i=i+4; break;}
        case "0xed": {output = output +" -"; break;}
        case "0xee": {output = output +` XRI D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xef": {output = output +" RST 5"; break;}
        case "0xf0": {output = output +" RP"; break;}
        case "0xf1": {output = output +" POP PSW"; break;}
        case "0xf2": {output = output +` JP ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; additionalBytes = 2; i=i+4; break;}
        case "0xf3": {output = output +" DI"; break;}
        case "0xf4": {output = output +` CP ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; additionalBytes = 2; i=i+4; break;}
        case "0xf5": {output = output +" PUSH PSW"; break;}
        case "0xf6": {output = output +` ORI D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xf7": {output = output +" RST 6"; break;}
        case "0xf8": {output = output +" RM"; break;}
        case "0xf9": {output = output +" SPHL"; break;}
        case "0xfa": {output = output +` JM adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; additionalBytes = 2; i=i+4; break;}
        case "0xfb": {output = output +" EI"; break;}
        case "0xfc": {output = output +` CM adr ${invadersDump.slice(i,i+2)} E ${invadersDump.slice(i+2,i+4)}`; additionalBytes = 2; i=i+4; break;}
        case "0xfd": {output = output +" -"; break;}
        case "0xfe": {output = output +` CPI D8 ${invadersDump.slice(i,i+2)}`;i=i+2; additionalBytes = 1; break;}
        case "0xff": {output = output +" RST 7"; break;}

        
    } 
    byteCounter = byteCounter + additionalBytes;
    additionalBytes = 0;
    console.log(output);
